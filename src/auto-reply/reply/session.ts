...
export async function initSessionState(params: {
  ...
  if (isNewSession) {
    ...
    sessionEntry.memoryFlushLastFailureAt = undefined;
    sessionEntry.memoryFlushNextAllowedAt = undefined;
    sessionEntry.memoryFlushContextTokensDefaultedAt = undefined;
  }
