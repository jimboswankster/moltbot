...
- Telegram: fit native command-menu registration within Telegram's count and aggregate text limits while preserving explicit commands ahead of generated skill commands.
